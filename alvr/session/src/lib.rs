    ...
    fn default() -> Self {
        Self {
            ...
            openvr_config: OpenvrConfig {
                ...
                headset_serial_number: "1WMGH000XX0000".into(),
                headset_tracking_system_name: "oculus".into(),
                headset_model_number: "Miramar".into(),
                headset_driver_version: "1.55.0".into(),
                headset_manufacturer_name: "Oculus".into(),
                headset_render_model_name: "generic_hmd".into(),
                headset_registered_device_type: "oculus/1WMGH000XX0000".into(),
                eye_resolution_width: 1440,
                eye_resolution_height: 1568,
                target_eye_resolution_width: 1056,
                target_eye_resolution_height: 1184,
                seconds_from_vsync_to_photons: 0.005,
                force_3dof: false,
                ...
                controllers_tracking_system_name: "oculus".into(),
                controllers_manufacturer_name: "Oculus".into(),
                controllers_model_number: "Miramar".into(),
                render_model_name_left_controller: "oculus_quest2_controller_left".into(),
                render_model_name_right_controller: "oculus_quest2_controller_right".into(),
                controllers_serial_number: "1WMGH000XX0000_Controller".into(),
                controllers_type_left: "oculus_touch".into(),
                controllers_type_right: "oculus_touch".into(),
                controllers_registered_device_type: "oculus/1WMGH000XX0000_Controller".into(),
                controllers_input_profile_path: "{oculus}/input/touch_profile.json".into(),
